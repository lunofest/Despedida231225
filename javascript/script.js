...
function updateTimer() {
  const targetDate = new Date("december 23, 2025 20:30:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const phoneNumber1 = '543625190185'; // Número para el primer botón
...
document.addEventListener('DOMContentLoaded', function() {
  // Definir los números de teléfono
  const recipientNumber1 = '543625190185'; // Número para el primer botón

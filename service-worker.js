const CACHE_NAME = 'cache-v52'; // Use a static or manually managed version
const RESOURCES_TO_PRECACHE = [
    'estilos/normalize.css?v52',
    'estilos/styles.css?v52',
    'estilos/mediaQueries.css?v52',
    'javascript/script.js?v52',
